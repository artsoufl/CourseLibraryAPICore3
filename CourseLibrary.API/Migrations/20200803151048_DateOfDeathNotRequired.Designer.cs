...
namespace CourseLibrary.API.Migrations
{
    ...
    [Migration("20200803151048_DateOfDeathNotRequired")]
    partial class DateOfDeathNotRequired
    {
            ...
            modelBuilder.Entity("CourseLibrary.API.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            DateOfDeath = new DateTimeOffset(new DateTime(1750, 7, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            FirstName = "Nancy",
